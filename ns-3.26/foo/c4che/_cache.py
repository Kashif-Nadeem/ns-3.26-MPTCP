...
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fwrapv', '-fstack-protector']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fwrapv', '-fstack-protector', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_SIGNAL_H': '', 'INT64X64_USE_CAIRO': '', 'HAVE_SYS_TYPES_H': '', 'PYTHONDIR': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYEXT': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PACKET_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_PYTHON_H': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'PYTHONARCHDIR': '', 'HAVE_GETENV': '', 'HAVE_RT': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['energy', 'udp-client-server', 'realtime', 'ipv6', 'udp', 'routing', 'wireless', 'naming', 'stats', 'socket', 'tutorial', 'error-model', 'matrix-topology', 'traffic-control', 'tcp']
...
LIBPATH_PYEXT = ['/usr/lib/python2.7/config']
LIBPATH_ST = '-L%s'
...
NS3_EXECUTABLE_PATH = ['/home/kashif/ns3/ns-allinone-3.26/ns-3.26/foo/src/fd-net-device', '/home/kashif/ns3/ns-allinone-3.26/ns-3.26/foo/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/i686-linux-gnu/4.9', '/home/kashif/ns3/ns-allinone-3.26/ns-3.26/foo']
...
VALGRIND_FOUND = True
VERSION = '3.26'
WITH_PYBINDGEN = '/home/kashif/ns3/ns-allinone-3.26/pybindgen-0.17.0.post57+nga6376f2'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/kashif/ns3/ns-allinone-3.26/ns-3.26/foo/ns3/config-store-config.h', '/home/kashif/ns3/ns-allinone-3.26/ns-3.26/foo/ns3/core-config.h']
cprogram_PATTERN = '%s'
