...
#ifndef RANDOMTRAFFIC_APPLICATION_H
#define RANDOMTRAFFIC_APPLICATION_H
...
*/
class RandomTrafficApplication : public Application 
{
public:
  /**
  ...
  RandomTrafficApplication ();

  virtual ~RandomTrafficApplication();
...
private:
  ...
  Ptr<RandomVariableStream>  m_PacketSize;       //!< Random variable stream for packet sizes.
  Ptr<RandomVariableStream>  m_PacketInterval;//!< Random variable stream for interval between sending packets.
  //Ptr<RandomVariableStream>    m_Deadline; // Random variable stream for packet deadlines
  ...
  bool     m_ecn;             //!< application ECN capability
private:
  /**
...
#endif /* RANDOMTRAFFIC_APPLICATION_H */
