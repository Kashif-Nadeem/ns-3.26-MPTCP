...
#ifndef MY_FIRST_CLIENT_H
#define MY_FIRST_CLIENT_H
...
/**
 * \ingroup myfirst
 * \brief A My First client
 *
 * Every packet sent should be returned by the server and received here.
 */
class MyFirstClient : public Application 
{
public:
  /**
