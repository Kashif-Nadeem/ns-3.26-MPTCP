 ...
 */
#ifndef RANDOM_TRAFFIC_HELPER_H
#define RANDOM_TRAFFIC_HELPER_H
...
public:
   ...
   *        to.
   */
  RandomTrafficHelper (std::string protocol, Address address);
