 ...
 */
#ifndef RANDOM_TRAFFIC_UDP_HELPER_H
#define RANDOM_TRAFFIC_UDP_HELPER_H
...
public:
   ...
   *        to.
   */
  RandomTrafficUdpHelper (std::string protocol, Address address);
...
#endif /* RANDOM_TRAFFIC_UDP_HELPER_H */
