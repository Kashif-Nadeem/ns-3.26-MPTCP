                        ...
                        Ptr<Ipv4Interface> interface)
{
  ...
  for (Ipv4EndPointDemux::EndPointsI endPoint = endPoints.begin ();
       endPoint != endPoints.end (); endPoint++)
    {
      ...
      std::cout<<"Udp received packet "<<x<<" at "<<Simulator::Now ().GetSeconds()
                                 << " data size " << packet->GetSize ()<<std::endl;
      NS_LOG_LOGIC ("Udp received packet "<<x<<" at "<<Simulator::Now ().GetSeconds()
                                 << " data size " << packet->GetSize ()); x++;
...
{ 
  ...
  std::cout<<"Udp sending packet "<<u<<" at-time "<<Simulator::Now ().GetSeconds()
                                 << " data-size " << packet->GetSize ()<<std::endl;
  NS_LOG_LOGIC ("Udp sending packet "<<u<<" at "<<Simulator::Now ().GetSeconds()
                                 << " data-size " << packet->GetSize ());  u++;
