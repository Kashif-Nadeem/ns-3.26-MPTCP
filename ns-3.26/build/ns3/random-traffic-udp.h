...
#ifndef RANDOMTRAFFIC_UDP_H
#define RANDOMTRAFFIC_UDP_H
...
*/
class RandomTrafficUdp : public Application 
{
public:
  /**
...
private:
  ...
  virtual void StartApplication (void);    // Called at time specified by Star
