...
protected:
   ...
   */
 // in followoing line virtual added by kashif for mptcpsocketbase
   ...
   */
  virtual void SendRST (void);  //virtual keyword added by kashif for mptcp
   ...
   */
    // in the following line virtual keyword added by kashif for mptcp
 ...
 virtual void ProcessClosing (Ptr<Packet> packet, const TcpHeader& tcpHeader);
  ...
  virtual bool UpdateWindowSize (const TcpHeader& header); //modified from above commented func by kashif
...
//bool        m_mptcpAllow;           //!< Window Scale option enabled
  ...
  uint32_t    m_mptcpPeerToken;      //!< Hash of the key
  bool        addrAdvertised;
